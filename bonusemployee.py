...
class Employee:
    ...
    def employee_panel(self):
        ...
        if choice == "1":
            ...
            avg_speed = input("Enter average speed (km/h): ")
            delay = input("Enter delay (minutes): ")
        ...
        #Bonus input    
            ...
            self.add_train(train_name, train_line, avg_speed, delay, quality,
                           ticket_price, capacity, distance, start_time, stop_time)
            self.employee_panel()
        elif choice == "6":
